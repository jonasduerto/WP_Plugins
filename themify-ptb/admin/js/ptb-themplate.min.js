...
"wait")},success:function(b){b&&"1"==b.status&&(a("#"+PTB.prefix+"success_text").html("<p><strong>"+b.text+"</strong></p>").show(),setTimeout(function(){a("#"+PTB.prefix+"success_text").html("").hide()},2E3),a.event.trigger("PTB.after_template_save"))}})},d);b.preventDefault()})},Validate:function(){var b=a('input[name="'+PTB.prefix+'ptt_offset_post"]');b.keypress(function(a){a=a.which?a.which:a.keyCode;return 46!=a&&31<a&&(48>a||57<a)?!1:!0});a('input[name="'+PTB.prefix+'ptt_pagination_post"]').change(function(c){0==
