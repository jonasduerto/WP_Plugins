...
class Builder_Countdown {
    ...
    public function admin_enqueue() {
        ...
        wp_enqueue_script('builder-countdown-admin', themify_enque($this->url . 'assets/admin.js'), array('jquery'), $this->version, true);
        wp_localize_script('builder-countdown-admin', 'builderCountDown', $this->localization());
        wp_enqueue_style('builder-countdown-admin', themify_enque($this->url . 'assets/admin.css'), null, $this->version);
    }
    ...
    public function frontend_style_enqueue($styles) {
        ...
        $styles[] = themify_enque(THEMIFY_METABOX_URI . 'css/jquery-ui-timepicker.min.css');
        return $styles;
    }
