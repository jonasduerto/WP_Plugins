...
class TB_Tile_Module extends Themify_Builder_Component_Module {
	...
	function get_assets() {
		...
		$fluid_tiles_enabled = $instance->get_option( 'fluid_tiles');
		if( $fluid_tiles_enabled == 1 || $fluid_tiles_enabled === 'yes' ) {
                        $fluid_tiles_base_size_value = $instance->get_option( 'fluid_tiles_base_size');
                        switch ($fluid_tiles_base_size_value) {
                            case '16':
                                $tiles_per_row =6;
                                break;
                            case '20':
			...
			$fluid_tiles[] = array(
				'query' => 'screen and (min-width: 425px) and (max-width: 768px)',
				'size' => $tiles_per_row
			);
			$fluid_tiles[] = array(
			...
			'ver' => $instance->version,
                ...
                if(Themify_Builder_Model::is_front_builder_activate()){
                    ...
                    $options['css'] = $instance->dynamic_css(false);
                }
					...
					'front' => array(
						...
						'fields' => array(
							...
							array(
								...
								'options' => $colors,
								'bottom' => true,
								'wrap_with_class' => 'tb-tile-options tb-tile-options-button tb-tile-options-text tb-tile-options-gallery',
								'render_callback' => array(
									'binding' => 'live'
								)
							),
							array(
								...
								'class' => 'fullwidth',
								'wrap_with_class' => 'tb-tile-options tb-tile-options-button tb-tile-options-text',
								'render_callback' => array(
									'binding' => 'live'
								)
							),
							...
							array(
								...
								'type' => 'wp_editor',
								'class' => 'fullwidth',
								'wrap_with_class' => 'tb-tile-options tb-tile-options-text',
								'render_callback' => array(
									'binding' => 'live'
								)
							),
							...
							array(
								...
								'class' => 'fullwidth',
								'wrap_with_class' => 'tb-tile-options tb-tile-options-button',
								'render_callback' => array(
									'binding' => 'live'
								)
							),
							...
							array(
								...
								'fields' => array(
									...
									array(
										...
										'class' => 'small',
										'wrap_with_class' => 'tb-group-element tb-group-element-icon tb-tile-options tb-tile-options-button',
										'render_callback' => array(
											'binding' => 'live'
										)
									),
							...
							array(
								'id' => 'gallery_front',
								'type' => 'textarea',
								'class' => 'fullwidth tb-shortcode-input',
								'label' => __('Gallery Slider', 'builder-tiles'),
								'help' => sprintf('<a href="#" class="builder_button tb-gallery-btn">%s</a>', __('Insert Gallery', 'builder-tiles')),
								'wrap_with_class' => 'tb-tile-options tb-tile-options-gallery',
								'render_callback' => array(
									'binding' => 'live'
								)
							),
							...
							array(
								...
								'wrap_with_class' => 'tb-tile-options tb-tile-options-map',
								'render_callback' => array(
									'binding' => 'live'
								)
							),
							...
							array(
								...
								'class' => 'fullwidth',
								'wrap_with_class' => 'tb-tile-options tb-tile-options-text tb-tile-options-gallery',
								'render_callback' => array(
									'binding' => 'live'
								)
							),
					...
					'back' => array(
						...
						'fields' => array(
							...
							array(
								...
								'fields' => array(
									...
									array(
										...
										'label' => __('Image URL', 'builder-tiles'),
										'class' => 'xlarge',
										'wrap_with_class' => 'tb-group-element tb-group-element-image tb-tile-options tb-tile-options-button',
										'render_callback' => array(
											'binding' => 'live'
										)
									),
							...
							array(
								...
								'wrap_with_class' => 'tb-tile-options tb-tile-options-button tb-tile-options-text tb-tile-options-gallery tb-tile-options-map',
								'render_callback' => array(
									'binding' => 'live'
								)
							),
					...
					<div class="tile-{{ side }} tile-type-{{ data[ 'type_' + side ] }} ui {{ data[ 'color_' + side ] }}">
						<div class="tile-inner">
							...
							<# } else if( data[ 'type_' + side ] === 'gallery' ) {
								themifybuilderapp.activeModel.trigger('custom:preview:refresh',data); // force reload
